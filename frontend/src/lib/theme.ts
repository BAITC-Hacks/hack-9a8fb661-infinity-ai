...
export const DARK: Palette = {
  ...
  blue: '#58a6ff', good: '#3fb950', warn: '#f0883e', bad: '#f85149', curve: '#a371f7', base: '#30363d', data: '#2dd4bf', sunk: '#0b0f14',
}
export const LIGHT: Palette = {
  bg: '#f6f8fa', panel: '#ffffff', line: '#d0d7de', text: '#1f2328', mute: '#59636e',
  blue: '#0969da', good: '#1a7f37', warn: '#bc4c00', bad: '#cf222e', curve: '#8250df', base: '#c8d1da', data: '#0f766e', sunk: '#eef1f4',
}
